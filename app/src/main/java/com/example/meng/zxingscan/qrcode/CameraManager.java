...
package com.example.meng.zxingscan.qrcode;
...
public final class CameraManager {
	...
	public Rect getFramingRect() {
		...
		if (framingRect == null) {
			...
			MAX_FRAME_WIDTH = (int) outMetrics.widthPixels * 2 / 3;
			MAX_FRAME_HEIGHT = (int) outMetrics.heightPixels / 3;
